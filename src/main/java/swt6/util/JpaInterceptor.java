...
import swt6.spring.persistence.JpaPersistenceManager;
...
public class JpaInterceptor {
  ...
  public Object holdEntityManager(ProceedingJoinPoint pjp) throws Throwable {
    ...
    if (TransactionSynchronizationManager.hasResource(entityManagerFactory))
      ...
      JpaPersistenceManager.openEntityManager(entityManagerFactory);
    }
    ...
    try {
      ...
      if (!participate) {
        JpaPersistenceManager.closeEntityManager(entityManagerFactory);
