...
public class DataOperations {
    ...
    public static final Operation INSERT_LOGBOOKENTRIES =
            insertInto("LOGBOOKENTRY")
                    ...
                    .values(102L, 101L, "Spy guard 1", DateUtil.getTime(2015, 11, 21, 17, 10), DateUtil.getTime(2015, 11, 21, 19, 0), 101L, 101L, 101L)
                    .values(103L, 102L, "Drill into wall", DateUtil.getTime(2015, 12, 1, 3, 13), DateUtil.getTime(2015, 12, 1, 5, 13), 101L, 102L, 102L)
                    ...
                    .values(106L, 102L, "Get resources", DateUtil.getTime(2016, 1, 3, 14, 20), DateUtil.getTime(2016, 1, 3, 16, 0), 102L, 101L, 105L)
                    .values(107L, 103L, "Check resources", DateUtil.getTime(2016, 1, 4, 13, 10), DateUtil.getTime(2016, 1, 4, 16, 0), 102L, 102L, 105L)
                    .values(108L, 103L, "Work on part 1", DateUtil.getTime(2017, 1, 7, 9, 0), DateUtil.getTime(2017, 1, 7, 18, 0), 102L, 101L, 104L)
                    .values(109L, 101L, "Repair part 2", DateUtil.getTime(2017, 2, 13, 9, 0), DateUtil.getTime(2017, 2, 13, 18, 25), 102L, 103L, 104L)
                    .build();
    ...
    public static final Operation INSERT_ISSUES =
            insertInto("ISSUE")
                ...
                .values(102L, "Steal diamond", 1000, 30, 0, 1, 102L, 101L)
                .values(103L, "Steal gold", 1000, 0, 0, 4, null, 101L)
                .values(104L, "Build stairs", 800, 46, 2, 3, 103L, 102L)
                .values(105L, "Buy more material", 500, 0, 0, 0, 101L, 102L)
                .build();
